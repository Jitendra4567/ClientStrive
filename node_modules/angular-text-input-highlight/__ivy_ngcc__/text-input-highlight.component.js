...
TextInputHighlightComponent.ɵfac = function TextInputHighlightComponent_Factory(t) { return new (t || TextInputHighlightComponent)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ChangeDetectorRef)); };
TextInputHighlightComponent.ɵcmp = /*@__PURE__*/ ɵngcc0.ɵɵdefineComponent({ type: TextInputHighlightComponent, selectors: [["mwl-text-input-highlight"]], viewQuery: function TextInputHighlightComponent_Query(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵviewQuery(_c0, 5);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.highlightElement = _t.first);
    } }, hostBindings: function TextInputHighlightComponent_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("resize", function TextInputHighlightComponent_resize_HostBindingHandler() { return ctx.onWindowResize(); }, false, ɵngcc0.ɵɵresolveWindow);
    } }, inputs: { tagCssClass: "tagCssClass", tags: "tags", textInputElement: "textInputElement", textInputValue: "textInputValue" }, outputs: { tagClick: "tagClick", tagMouseEnter: "tagMouseEnter", tagMouseLeave: "tagMouseLeave" }, features: [ɵngcc0.ɵɵNgOnChangesFeature], decls: 2, vars: 2, consts: [[1, "text-highlight-element", 3, "ngStyle", "innerHtml"], ["highlightElement", ""]], template: function TextInputHighlightComponent_Template(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵelement(0, "div", 0, 1);
    } if (rf & 2) {
        ɵngcc0.ɵɵproperty("ngStyle", ctx.highlightElementContainerStyle)("innerHtml", ctx.highlightedText, ɵngcc0.ɵɵsanitizeHtml);
    } }, directives: [ɵngcc1.NgStyle], encapsulation: 2 });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TextInputHighlightComponent, [{
        type: Component,
        args: [{
    ...
    }], function () { return [{ type: ɵngcc0.Renderer2 }, { type: ɵngcc0.ChangeDetectorRef }]; }, { tagCssClass: [{
            type: Input
        }], tags: [{
            type: Input
        }], tagClick: [{
